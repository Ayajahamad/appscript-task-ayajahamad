    ...
    <header>
        <marquee behavior="" direction="" className="backGround">
            <div className='marquee'>
                <p><i className="bi bi-flower2"></i>Lorem ipsum dolor</p>
                <p><i className='bi bi-flower2'></i>Lorem ipsum dolor</p>
                <p><i className='bi bi-flower2'></i>Lorem ipsum dolor</p>
                <p><i className='bi bi-flower2'></i>Lorem ipsum dolor</p>
                <p><i className='bi bi-flower2'></i>Lorem ipsum dolor</p>
                ...
                <nav className={`navbar1 ${isOpen ? 'open' : 'close'}`}>
                    <button onClick={() => setShowFilter(!showFilter)} className='btn1'>
                        <button className="navbar-toggler" onClick={toggleNavbar}>
                            <span><img src="https://res.cloudinary.com/dvzviljl7/image/upload/v1710492408/menu-bar_9190853-removebg-preview_gizo3u.png" alt="nav-bar toggler" className='toggler' /></span>
                        </button>
                    </button>
                </nav>
                <div className='logo'>
