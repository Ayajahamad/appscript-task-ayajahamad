        ...
        <div className="fisrtfooter">
            ...
            <div className='contactfooter'>
                ...
                <div className='currencyfooter'>
                    ...
                    <div>
                        <img src="https://upload.wikimedia.org/wikipedia/en/thumb/4/41/Flag_of_India.svg/1200px-Flag_of_India.svg.png" alt="flag-image"  className='imgfooter'/> .USD
                    </div>
            ...
            <div>
                ...
                <div className='accepfooter'>
                    ...
                    <div className='imagefooter'>
                        <li>
                            <img src="https://resize.indiatvnews.com/en/centered/newbucket/1200_675/2023/04/google-pay-1680875397.jpg" alt="google pay" />
                        </li>
                        <li>
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/Maestro_logo.svg/126px-Maestro_logo.svg.png" alt="maestro logo" />
                        </li>
                        <li>
                            <img src="https://w7.pngwing.com/pngs/632/1015/png-transparent-paypal-logo-computer-icons-payment-paypal-blue-angle-service-thumbnail.png" alt="paypal" />
                        </li>
                        <li>
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDwq7Nu971X79BB0RjgvrlJzup5kPz10tFYqEwOOvTXZBPyATrsH0TDKC2M6QqbmH-hR4&usqp=CAU" alt="image" />
                        </li>
                        <li>
                            <img src="https://developer.apple.com/news/images/og/apple-pay-og-twitter.jpg" alt="twitter" />
                        </li>
                    </div>
                </div>
            </div>
